...
const ProblemCard: React.FC<{ icon: React.ReactNode; title: string; text: string }> = ({ icon, title, text }) => (
    <div className="group bg-white p-6 md:p-10 rounded-[40px] border border-slate-200 shadow-[0_40px_100px_-20px_rgba(0,0,0,0.05)] transition-all duration-500 hover:-translate-y-2 hover:shadow-[0_40px_80px_-20px_rgba(197,160,89,0.1)] hover:border-gold/50 flex flex-col items-center text-center h-full">
        ...
        <p className="text-slate-600 text-[16px] leading-relaxed font-light">{text}</p>
    </div>
);
