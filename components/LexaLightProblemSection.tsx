...
const ProblemCard: React.FC<{ icon: React.ReactNode; title: string; text: string }> = ({ icon, title, text }) => (
    <div className="group bg-white p-10 rounded-[40px] border border-slate-100 shadow-[0_20px_40px_-15px_rgba(0,0,0,0.05)] transition-all duration-500 hover:-translate-y-2 hover:shadow-[0_40px_80px_-20px_rgba(0,0,0,0.1)] hover:border-gold/20 flex flex-col items-center text-center h-full">
...
export const LexaLightProblemSection: React.FC = () => {
    return (
        <section className="py-32 bg-[#F1F5F9] reveal"> {/* Slightly darker tinted background (slate-100) */}
