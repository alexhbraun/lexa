        ...
        <section className="py-16 md:py-24 bg-slate-50 reveal">
            <div className="container mx-auto px-6 text-center">
                <button
                    ...
                    className="shimmer w-full sm:w-auto flex sm:inline-flex items-center justify-center gap-3 bg-navy-acc text-white font-bold text-lg sm:text-xl px-8 sm:px-12 py-5 sm:py-6 rounded-full transition-all duration-500 hover:scale-105 shadow-[0_40px_80px_-15px_rgba(5,16,32,0.4)]"
                >
                    <ShieldCheckIcon className="w-6 h-6 text-gold shrink-0" />
                    <span className="leading-tight">Analisar elegibilidade</span>
                </button>
